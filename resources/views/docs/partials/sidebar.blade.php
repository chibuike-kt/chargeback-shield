<aside class="hidden lg:block w-56 shrink-0 border-r border-slate-100 sticky top-14 h-[calc(100vh-3.5rem)] overflow-y-auto py-6 px-3">
  ...
  <a href="/docs#get-dispute" class="nav-link">Get dispute</a>
  <a href="/docs#list-disputes" class="nav-link">List disputes</a>

  <p class="nav-section">Guides</p>
  <a href="/docs#scoring" class="nav-link">How scoring works</a>
  <a href="/docs#decisions" class="nav-link">Understanding decisions</a>
  <a href="/docs#evidence-vault" class="nav-link">Evidence vault</a>
  <a href="/docs#webhooks" class="nav-link">Webhooks</a>
  <a href="/docs#reason-codes" class="nav-link">Reason codes</a>

  <p class="nav-section">SDKs</p>
  <a href="/docs#sdk-node" class="nav-link">Node.js</a>
  <a href="/docs#sdk-php" class="nav-link">PHP / Laravel</a>
